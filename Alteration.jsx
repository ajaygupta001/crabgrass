...
const Alteration = () => {
  ...
  const searchHandler = () => {
    let dummyData = search.toLowerCase();
        ...
        <div className="  body-scroll">
          ...
          <div className="h-20 border-b-2 rounded-2xl mx-6 flex items-center justify-around">
            <div className="flex flex-col justify-center text-gray-700">
              <label htmlFor="">Tailor name:</label>

              <input
                className="px-4 py-1 border-2 border-gray-600 rounded"
                type="text"
              ...
              <table className="w-[76vw] whitespace-nowrap">
                <thead>
                  <tr className="h-10   leading-none text-black text-m bg-blue-400">
                    ...
                    <th className="font-normal text-left pl-2 w-16">Action</th>
                  </tr>
                </thead>
